...
public:
   ...
   bool operator!=(const linkedListIterator<Type>& right) const; 
    ...
    //virtual void deleteSmallest();
     //The function to delete the smallest item from the list
private:
...
public:
    ...
    virtual void deleteNode(const Type& deleteItem) = 0;
     ...
     virtual void deleteSmallest() = 0;
      //This function deletes the smallest value from the list
    ...
    void printReverse(nodeType<Type> *current);
     //This function prints the list reversed
 
    void printListReverse();
     //calls the above function to reverse print
...
template <class Type>
void linkedListType<Type>::printReverse(nodeType<Type> *current) 
{
	if(current != NULL)
			return;
