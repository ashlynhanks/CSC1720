...
public:
    ...
    void reverseStack (linkedStackType<Type> &otherStack);
      //This function reverses the reverses the stack 
      //Precondition: The stack has to exist and cannot be empty
      //Postcondition: If the stack is empty then the function will
      //not run, if the stack is not empty then the stack will 
